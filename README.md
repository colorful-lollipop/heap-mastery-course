...
这是一个全面的堆漏洞利用教学项目，专为安全入门人员、CTF选手和安全研究人员设计。通过**8个难度递增的关卡**，你将从基础的堆操作逐步掌握高级的堆喷和堆风水技术。
...
```bash
# 克隆仓库
git clone https://github.com/colorful-lollipop/heap-mastery-course.git
...
- [可视化图表](docs/VISUAL_DIAGRAMS.md) - ASCII 图表详解堆结构和攻击技术
...
./vuln                   # 运行漏洞程序
python3 ../../solution/exploit_solution.py  # 运行利用脚本
...
**有问题?** 查看 [常见问题](#常见问题) 或提交 [Issue](https://github.com/colorful-lollipop/heap-mastery-course/issues)
